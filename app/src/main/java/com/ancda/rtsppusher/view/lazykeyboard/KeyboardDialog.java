...
public class KeyboardDialog extends Dialog implements KeyboardView.OnKeyboardActionListener {
    ...
    private DialogCustomKeyboardBinding mBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DialogCustomKeyboardBinding.inflate(LayoutInflater.from(getContext()));
    ...
    protected void onStart() {
        ...
        if (window != null) {
            ...
            layoutParams.width = CommonUtil.dip2px(getContext(), 730);
    ...
    private void initKeyboards() {
        ...
        mCurrentOrder = attribute.keyboardMode;
